...
<html lang="en">
    ...
    <body>
                ...
                <div class="col-md-9 register-right">                       
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            $ctv = $conn->query("SELECT * from loaiphanung where IdLoaiPhanUng='$idmonan'");
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Nhập tên loại PƯ" name="txtTenHoaHoc" value="<?php echo $row['TenLoaiPhanUng']; ?>" required autofocus/>
                                        </div>
        ...
        if (isset($_POST['btnDangKy'])) {
            ...
            $conn->query("UPDATE `loaiphanung` SET `TenLoaiPhanUng`='$tenhh',`MoTa`= '$mota' WHERE IdLoaiPhanUng = '$idmonan'");
