                                ...
                                <table class="table table-bordered table-hover table-striped" style="font-size:14px">
                                    ...
                                    while ($row = mysqli_fetch_array($chat)) {
                                        ?>          <tr>
                                            ...
                                            <td class="center" style="vertical-align: middle">
                                                <a href="sua_loai_chat.php?IdLoai=<?php echo $row['IdLoai'] ?>">  <img src="images/icon-update.png" style="width: 40px; height: 40px" title="Sửa món ăn" alt=""/> </a>                          
                                                <a href="xoa_loai_chat.php?IdLoai=<?php echo $row['IdLoai'] ?>" title="BCDONLINE CONFIRM YES/ NO" onclick="return confirmAction()">  <img src="images/icon-delete.png" style="width: 40px; height: 40px" title="Xóa món ăn" alt=""/> </a>                                           
                                            </td>
                                        </tr>
                                        <?php
                                    }
