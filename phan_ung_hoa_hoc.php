                    ...
                    <div class="span12">
                        <div class="row">
                            <div class="span12">
                                ...
                                <h4 class="center">DANH SÁCH PƯ HÓA HỌC</h4>
                                <p class="container left">
                                    <a href="them_phan_ung.php">  <img src="images/icon-add_1.png" style="width: 60px; height: 60px" title="Thêm mới" alt=""/> </a>                             
                                </p>
                                    ...
                                    while ($row = mysqli_fetch_array($chat)) {
                                        ?>          <tr>
                                            <td class="center" style="vertical-align: middle">
                                                <?php echo $row['ChatThamGia1']; ?>
                                            </td>

                                            <td class="center" style="vertical-align: middle">
                                                <?php echo $row['ChatThamGia2']; ?>
                                            </td>

                                            <td class="center" style="vertical-align: middle">
                                                <?php echo $row['ChatSanPham1']; ?>
                                            </td>

                                            <td class="center" style="vertical-align: middle">
                                                <?php echo $row['ChatSanPham2']; ?>
                                            </td>
