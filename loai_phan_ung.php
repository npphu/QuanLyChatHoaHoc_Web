                    ...
                    <div class="span12">
                        <div class="row">
                            <div class="span12">
                                ...
                                <h4 class="center">DANH SÁCH LOẠI PƯ</h4>
                                <p class="container left">
                                    <a href="them_loai_phan_ung.php">  <img src="images/icon-add_1.png" style="width: 60px; height: 60px" title="Thêm mới" alt=""/> </a>                             
                                </p>
                                <table class="table table-bordered table-hover table-striped" style="font-size:14px">
                                    ...
                                    $chat = $conn->query("SELECT * from loaiphanung order by TenLoaiPhanUng ");
                                    while ($row = mysqli_fetch_array($chat)) {
                                        ?>          <tr>
                                            <td class="center" style="vertical-align: middle">
                                                <?php echo $row['TenLoaiPhanUng']; ?>
                                            </td>
                                            ...
                                            <td class="center" style="vertical-align: middle">
                                                <a href="sua_loai_phan_ung.php?IdLoaiPhanUng=<?php echo $row['IdLoaiPhanUng'] ?>">  <img src="images/icon-update.png" style="width: 40px; height: 40px" title="Sửa" alt=""/> </a>                          
                                                <a href="xoa_loai_phan_ung.php?IdLoaiPhanUng=<?php echo $row['IdLoaiPhanUng'] ?>" title="BCDONLINE CONFIRM YES/ NO" onclick="return confirmAction()">  <img src="images/icon-delete.png" style="width: 40px; height: 40px" title="Xóa" alt=""/> </a>                                           
                                            </td>
                                        </tr>
                                        <?php
                                    }
